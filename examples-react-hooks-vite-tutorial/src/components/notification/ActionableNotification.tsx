...
export function ActionableNotification({ items }: { items: EngagespotNotification[] }) {
                        ...
                        <Button
                           ...
                           onClick={() => {
                              actions.changeState({
                                 id: Number(item.id),
                                 /**
                                  * write your own custom logic here, this is just a common catch all
                                  * usually we change state according to specific ids
                                  * Eg: block.id === actionable-notification_b0_state_1_i0 ? 'state_2' : 'state_3'
                                  */
                                 state:
